...
* Lecture 12 Stochastic Optimization  [[notes](../notes/lecture14.pdf)]
  * Stochastic gradient descent [[notes](../notes/supp1.pdf)]
  * [Sample codes for reproducing Figure 13.1](https://github.com/wangyuanhao/optimization_method_course_webpage/tree/master/codes/stochastic_optimization) in Gartner, B., He, N., and Jaggi, M. Lectures notes on *Optimization for Data Science*. [credit to ChatGPT]
    * Reading
